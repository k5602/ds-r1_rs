...
impl ModelConfig {
    ...
    pub fn validate(&self) -> Result<()> {
        if self.vocab_size == 0 {
            return Err(ModelError::Config("vocab_size must be greater than 0".to_string()));
        }
        ...
        if self.num_layers == 0 {
            return Err(ModelError::Config("num_layers must be greater than 0".to_string()));
        }
        
        if self.num_heads == 0 {
            return Err(ModelError::Config("num_heads must be greater than 0".to_string()));
        }
        ...
        if self.num_experts == 0 {
            return Err(ModelError::Config("num_experts must be greater than 0".to_string()));
        }
